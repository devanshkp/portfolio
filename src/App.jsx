...
function IntroPattern() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M18 178C82 54 202 18 398 46" />
      <path d="M50 202C104 92 220 48 402 72" />
      <path d="M114 214C154 126 250 80 408 98" />
      <path className="intro-pattern-dash" d="M206 18V176M132 104H376" />
      <circle cx="206" cy="104" r="4" />
      <circle cx="311" cy="61" r="2.5" />
      <circle cx="362" cy="91" r="2.5" />
    </svg>
  );
}
