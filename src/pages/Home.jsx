  ...
  return (
    ...
    >
      ...
      >
        {/* Navigation */}
        <nav
          className={`fixed top-0 w-full z-50 backdrop-blur-xl bg-bg-nav/80 bg-opacity-60 border-border border-b-1`}
        >
          {/* Scroll progress bar */}
          <div
            id="scroll-progress"
            ...
            <div className="mx-auto">
              <div className="flex items-center justify-between mb-12">
                ...
                <a
                  ...
                  className={`group transition-all duration-300 text-text-muted hover:text-text-primary inline-flex items-center gap-1 rounded-lg px-3 py-2 bg-bg-secondary hover:scale-105`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
